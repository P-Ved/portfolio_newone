      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                REST APIs, and strong database design focused on scalable CRUD
                operations.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AI / LLM</h3>
              <h4>LLM Integration & Workflow</h4>
              <p>
                Building AI features with LLM integrations and practical prompt
                pipelines, supported by strong collaboration and analytics
                tooling.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
